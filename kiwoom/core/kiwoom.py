...
class Kiwoom(QAxWidget):
    def __init__(self, bot=None):
        # Prevent from creating multiple QAxWidgets
        if bot:
            super().__init__()
            self.msg = True
    ...
    def set_input_value(self, id, value):
        """
          ...
          -------------------------------------------------------------------------------------------------------
        """
        return self.call("SetInputValue(QString, QString)", id, value)
    ...
    def disconnect_real_data(self, scr_no):
        ...
        """
        return self.call("DisconnectRealData(QString)", scr_no)
    ...
    def send_condition(self, scr_no, cond_name, index, search):
        """
          ...
          ------------------------------------------------------------------------------------------------------
        """
        self.call("SendCondition(QString, QString, Int, Int)", scr_no, cond_name, index, search)
    ...
    def send_condition_stop(self, scr_no, cond_name, index):
        ...
        """
        return self.call("SendConditionStop()")
